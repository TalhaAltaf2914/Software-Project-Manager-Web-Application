...
export default function Signup () {
    ...
    const handleSubmit = (e) =>{
        ...
        axios.post('http://localhost:4000/api/v1/auth/signup', {firstName, lastName, email, password}).then(res=>{
        ...
        <div className='login-signup-page'>
            ...
            <form onSubmit={handleSubmit} className='login-signup-form'>
                ...
                <div className='form-section'>
                    <label htmlFor='firstName' className='form-section-label'>First Name</label>
                    <input required id='firstName' type='text' className='form-section-text-control' placeholder='First Name' 
                        value={firstName}
                ...
                <div className='form-section'>
                    <label htmlFor='lastName' className='form-section-label'>Last Name</label>
                    <input required id='lastName' type='text' className='form-section-text-control' placeholder='Last Name' 
                    value={lastName}
                    onChange={(e)=>{console.log(e.target.value); setLastName(e.target.value);}}/>
                </div>
                ...
                <input className='form-submit-btn' type='submit' value='Signup'/>
                
                <input className='form-submit-btn' type='button' value='Login' onClick={()=>{nav('/login')}}/>
            </form>
        </div>
    );
}